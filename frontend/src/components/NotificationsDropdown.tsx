      ...
      {({ open }) => (
        <>
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Popover.Panel className="absolute right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-[360px] max-w-[360px] bg-white dark:bg-[#0F1E2E] dark:border-[rgba(124,58,237,0.18)] rounded-xl shadow-elev-3 border border-neutral-100 z-[200]">
